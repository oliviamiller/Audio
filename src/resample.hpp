...
void resample_audio(int input_sample_rate,
    ...
    VIAM_SDK_LOG(debug) << "resample_audio called: input_rate=" << input_sample_rate
    ...
    VIAM_SDK_LOG(debug) << "Resampling successful: input_samples=" << input_samples
                        << " output_samples_done=" << output_done
